...
N 780 -630 830 -630 {lab=sub}
N -90 -630 -40 -630 {lab=sub}
...
N 1150 -480 1150 -460 {lab=gnd}
N 1150 -550 1150 -540 {lab=sub}
...
m=4}
C {lab_pin.sym} 540 -410 3 0 {name=p14 sig_type=std_logic lab=sub}
C {lab_pin.sym} 210 -410 3 0 {name=p15 sig_type=std_logic lab=sub}
...
C {lab_pin.sym} 830 -630 0 1 {name=p21 sig_type=std_logic lab=sub}
C {lab_pin.sym} -90 -630 2 1 {name=p22 sig_type=std_logic lab=sub}
...
C {sg13g2_pr/ptap1.sym} 1150 -510 2 0 {name=R2
model=ptap1
spiceprefix=X
w=37.6237375e-6
l=0.2962625e-6
}
C {lab_pin.sym} 1150 -460 0 0 {name=p13 sig_type=std_logic lab=gnd
m=4}
C {lab_pin.sym} 1150 -550 0 1 {name=p16 sig_type=std_logic lab=sub}
C {lab_pin.sym} 1280 -550 0 1 {name=p17 sig_type=std_logic lab=well}
C {lab_pin.sym} 910 -510 0 0 {name=p10 sig_type=std_logic lab=sub}
